MapSongBanks::
	...
	db MUSIC_SLOW_MOON, 0 ; UNUSED_MAP_69
	db MUSIC_ROCKET_RADIO, 0 ; UNUSED_MAP_6A
	db MUSIC_LAVENDER, 0 ; UNUSED_MAP_6B
	db MUSIC_DUNGEON3, 0 ; VICTORY_ROAD_1F
	db MUSIC_RUINS_RADIO, 0 ; UNUSED_MAP_6D
	...
	db MUSIC_IMAKUNI_2, 0 ; CELADON_MART_ROOF
	...
	db MUSIC_POKEMON_TOWER, 0 ; FUCHSIA_GYM
	...
	db MUSIC_DUNGEON1, 0 ; UNUSED_MAP_F3
	db MUSIC_IMAKUNI_2,0 ; UNUSED_MAP_F4
	db MUSIC_SILPH_CO, 0 ; LORELEIS_ROOM
	db MUSIC_CINNABAR, 0 ; BRUNOS_ROOM
