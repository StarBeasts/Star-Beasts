Route8_Object:
	...
	def_warp_events
	warp_event  0,  0, ROUTE_8_GATE, 1
	warp_event  0,  0, ROUTE_8_GATE, 2
	warp_event  6,  9, ROUTE_8_GATE, 3
	warp_event  6, 10, ROUTE_8_GATE, 4
	...
	def_object_events
	object_event  8,  5, SPRITE_ERIKA, STAY, RIGHT, 1, OPP_SUPER_NERD, 3
	object_event 13,  9, SPRITE_GAMBLER, STAY, UP, 2, OPP_GAMBLER, 5
	object_event 42,  6, SPRITE_ERIKA, STAY, UP, 3, OPP_SUPER_NERD, 4
	object_event 26,  3, SPRITE_COOLTRAINER_F, STAY, LEFT, 4, OPP_LASS, 13
	object_event 26,  4, SPRITE_ERIKA, STAY, RIGHT, 5, OPP_SUPER_NERD, 5
