Route13_Object:
	...
	def_object_events
	object_event 49, 10, SPRITE_OFFICER, STAY, RIGHT, 1, OPP_BIRD_KEEPER, 1
	...
	object_event 12,  4, SPRITE_OFFICER, STAY, RIGHT, 6, OPP_BIRD_KEEPER, 2
	...
	object_event  7, 13, SPRITE_OFFICER, STAY, UP, 10, OPP_BIRD_KEEPER, 3
