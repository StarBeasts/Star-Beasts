VermilionGym_Object:
	...
	object_event  9,  6, SPRITE_GRAMPS, STAY, LEFT, 2, OPP_GAMBLER, 6
	object_event  3,  8, SPRITE_GAMBLER, STAY, LEFT, 3, OPP_CUE_BALL, 10
	object_event  0, 10, SPRITE_ROCKET, STAY, RIGHT, 4, OPP_ROCKET, 22
