Route12_Object:
	...
	object_event 11, 92, SPRITE_SUPER_NERD, STAY, LEFT, 4, OPP_JR_TRAINER_M, 9
	object_event 14, 76, SPRITE_MIDDLE_AGED_MAN, STAY, UP, 5, OPP_CUE_BALL, 8
