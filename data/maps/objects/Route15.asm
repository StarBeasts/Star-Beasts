Route15_Object:
	...
	object_event 31, 13, SPRITE_OFFICER, STAY, UP, 3, OPP_BIRD_KEEPER, 6
	object_event 35, 13, SPRITE_OFFICER, STAY, UP, 4, OPP_BIRD_KEEPER, 7
	...
	object_event 15,  8, SPRITE_COOLTRAINER_F, STAY, DOWN, 10, OPP_LORELEI, 1
	object_event 18,  5, SPRITE_POKE_BALL, STAY, NONE, 11, TM_FALCON_PUNCH
