Route14_Object:
	...
	object_event 15,  6, SPRITE_OFFICER, STAY, DOWN, 2, OPP_BIRD_KEEPER, 15
	object_event 12, 11, SPRITE_OFFICER, STAY, DOWN, 3, OPP_BIRD_KEEPER, 16
	object_event 14, 15, SPRITE_OFFICER, STAY, UP, 4, OPP_BIRD_KEEPER, 17
	object_event 15, 31, SPRITE_OFFICER, STAY, LEFT, 5, OPP_BIRD_KEEPER, 4
	object_event  6, 49, SPRITE_OFFICER, STAY, UP, 6, OPP_BIRD_KEEPER, 5
