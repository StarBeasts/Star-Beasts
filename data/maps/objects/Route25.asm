Route25_Object:
	...
	object_event 24,  4, SPRITE_YOUNGSTER, STAY, DOWN, 2, OPP_YOUNGSTER, 6
	object_event 18,  8, SPRITE_COOLTRAINER_M, STAY, RIGHT, 3, OPP_JR_TRAINER_M, 2
	object_event 23,  9, SPRITE_COOLTRAINER_F, STAY, UP, 4, OPP_LASS, 9
	...
	object_event 18,  5, SPRITE_HIKER, STAY, UP, 8, OPP_HIKER, 3
