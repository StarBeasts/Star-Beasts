...
; Route 3
	...
	db 14, SPEAROW, 0
; Mt. Moon 1F
	db 10, RATTATA, VOLTORB, ZUBAT, 0
; Route 24
	db 14, RATTATA, EKANS, VOLTORB, 0
; Route 25
...
; Route 17
	...
	db 28, CLEFAIRY, GRIMER, VICTREEBEL, 0
	db 33, KOFFING, 0
	db 29, ELECTRODE, EXEGGCUTE, 0
...
; Viridian Gym
	db $FF, 44, RHYHORN, 45, ONIX, 44, TENTACRUEL, 45, FARFETCHD, 50, NIDOKING, 0
...
; Silph Co. 10F
	db 33, HYPNO, 0
; Silph Co. 11F
	db 25, GOLBAT, PSYDUCK, ELECTRODE, GOLDUCK, EKANS, 0
